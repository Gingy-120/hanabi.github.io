...
- The _4 Charm_ is introduced at [level 23](../level-23.mdx#the-4-charm).
- Some specific _4 Charm_ interactions apply when playing at max level, which are detailed below.

#### Interaction Between The 4 Charm and Double Bluffs Where Cathy Has a One-Away-From-Playable Card
...
#### Interaction Between the 4 Charm and the Out-of-Order Finesse

- First, see the section on the _[Out-of-Order Finesse](../level-20.mdx#the-out-of-order-finesse)_.
...
- For example, in a 3-player game:
  ...
  - Bob knows that this signals a blind-play:
    ...
    - A _Third Finesse Position_ blind-play would look like a _Unknown Trash Discharge_, which would be a \_Lie_.
